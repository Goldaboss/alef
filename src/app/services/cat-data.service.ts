...
export class CatDataService {
  private data: Cat[] = [
    ...
    {img: './assets/img/cats/cat-2.png', name: 'Кот полосатый', color: 'Коричневый окрас', age: 7, paws: 4, price: 40000, stoke: false},
    ...
    {img: './assets/img/cats/cat-1.png', name: 'Кот полосатый', color: 'Коричневый окрас', age: 3, paws: 4, price: 25000, stoke: false},
    ...
    {img: './assets/img/cats/cat-2.png', name: 'Кот полосатый', color: 'Коричневый окрас', age: 17, paws: 4, price: 11000, stoke: false},
    ...
    {img: './assets/img/cats/cat-3.png', name: 'Кот полосатый', color: 'Коричневый окрас', age: 21, paws: 4, price: 37000, stoke: false},
